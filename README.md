...
* MER .pfb and .iv meshes can have multiple level of details (LOD) within the mesh.  When this occurs, only the most detailed LOD is kept for the .obj, and the other LODs are discarded. 
